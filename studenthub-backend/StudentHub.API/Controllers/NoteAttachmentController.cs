...
public class NoteAttachmentController : ApiBaseController
{
    ...
    public NoteAttachmentController(AppDbContext db, IWebHostEnvironment env, IConfiguration config)
    {
        _db = db;
        _env = env;
        _config = config;
...
public async Task<IActionResult> Upload(IFormFile file)
{
    ...
    // Validare MIME corelat cu extensia
