export const environment = {
  production: true,
  apiUrl: 'https://studenthub-upt.duckdns.org/api',
  msalConfig: {
    clientId: '5664b036-83c1-441c-bed5-434a53933c07',
    tenantId: '6bb41fe4-40a3-4a10-b6cd-38278e78b21a',
    redirectUri: 'https://studenthub-upt.duckdns.org/callback',
    postLogoutRedirectUri: 'https://studenthub-upt.duckdns.org',
